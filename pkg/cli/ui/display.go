...
func PrintBanner() {
  ...
  / ____| |           | |           | |   |  ____|                  | |
 | (___ | |_ __ _ _ __| | ___ _ __  | |_  | |__ __ _ _   _  ___ ___| |_
  \___ \| __/ _` + "`" + ` | '__| |/ / '_ \ | __| |  __/ _` + "`" + ` | | | |/ __/ _ \ __|
  ____) | || (_| | |  |   <| | | || |_  | | | (_| | |_| | (_|  __/ |_
 |_____/ \__\__,_|_|  |_|\_\_| |_| \__| |_|  \__,_|\__,_|\___\___|\__|

    ⚡ Powered by Starknet • Secured by Proof of Work ⚡
`
